# Security Group for Application Load Balancer (Presentation Tier)
...
# Security Group for ECS Services (Application Tier)
...
# Security Group for RDS PostgreSQL (Data Tier)
...
# Security Group for ElastiCache Redis (Data Tier)
